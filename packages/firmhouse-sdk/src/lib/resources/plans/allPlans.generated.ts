...
export type AllPlansQuery_plans_PlanConnection_pageInfo_PageInfo = { endCursor: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null };

export type AllPlansQuery_plans_PlanConnection_nodes_Plan_planProducts_PlanProduct_product_Product = { available: boolean, eligibleForDiscount: boolean, graceCancellationEnabled: boolean | null, graceCancellationPeriod: number | null, graceCancellationUnit: Types.CommitmentUnit | null, id: string, imageUrl: string | null, interval: number | null, intervalUnitOfMeasure: string | null, mandatory: boolean, maximumCommitmentEnabled: boolean | null, maximumCommitmentPeriod: number | null, maximumCommitmentUnit: Types.MaximumCommitmentUnit | null, metadata: unknown, minimumCommitmentEnabled: boolean | null, minimumCommitmentPeriod: number | null, minimumCommitmentUnit: Types.CommitmentUnit | null, nthProductFree: number | null, priceCents: number | null, priceExcludingTaxCents: number | null, priceIncludingTaxCents: number | null, productType: string | null, shopifyProductId: string | null, shopifyVariantId: string | null, sku: string | null, slug: string, supplier: string | null, taxAmountCents: number | null, taxPercentage: number | null, title: string };

export type AllPlansQuery_plans_PlanConnection_nodes_Plan_planProducts_PlanProduct = { quantity: number, product: AllPlansQuery_plans_PlanConnection_nodes_Plan_planProducts_PlanProduct_product_Product };

export type AllPlansQuery_plans_PlanConnection_nodes_Plan = { available: boolean, currency: string | null, graceCancellationEnabled: boolean, graceCancellationPeriod: number, graceCancellationUnit: Types.CommitmentUnit, id: string, imageUrl: string | null, initialAmountExcludingTaxCents: number | null, initialAmountIncludingTaxCents: number | null, instalmentIntervalPeriod: number | null, instalmentIntervalUnit: Types.BaseIntervalUnit | null, instalments: number | null, maximumCommitmentEnabled: boolean | null, maximumCommitmentPeriod: number | null, maximumCommitmentUnit: Types.MaximumCommitmentUnit | null, metadata: unknown, minimumCommitmentEnabled: boolean, minimumCommitmentPeriod: number, minimumCommitmentUnit: Types.CommitmentUnit, monthlyAmountCents: number | null, monthlyAmountExcludingTaxCents: number | null, monthlyAmountIncludingTaxCents: number | null, name: string, slug: string, taxAmountCents: number | null, taxPercentage: number | null, planProducts: Array<AllPlansQuery_plans_PlanConnection_nodes_Plan_planProducts_PlanProduct> | null };

export type AllPlansQuery_plans_PlanConnection = { totalCount: number | null, pageInfo: AllPlansQuery_plans_PlanConnection_pageInfo_PageInfo, nodes: Array<AllPlansQuery_plans_PlanConnection_nodes_Plan | null> | null };

export type AllPlansQuery_Query = { plans: AllPlansQuery_plans_PlanConnection | null };

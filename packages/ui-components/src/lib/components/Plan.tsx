...
export function Plan({ children, locale, isActive, className, ...plan }: PlanProps) {
  return (
    <div className={`flex flex-col justify-between flex-shrink-0 p-4 m-2 rounded-2xl w-48 ${isActive ? 'bg-black text-white scale-105 transition-transform' : 'bg-white'} ${className ?? ''}`}>
